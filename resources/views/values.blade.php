<x-guest-layout>
    @php
        $values = [
            ...
            [
                'title' => 'Juntos',
                'desc' => 'Nos respetamos y sacamos fuerza de nuestras diferencias.',
                'icon' =>
            ...
            <div class="text-center max-w-3xl mx-auto mb-20 values-header opacity-0 translate-y-8">
                ...
                <div class="relative">
                    <p class="text-xl text-gray-600 italic leading-relaxed">
                        Guían nuestro comportamiento en el día a día, informando cómo actuamos, las decisiones que
                        tomamos y cómo trabajamos entre nosotros, nuestros clientes y todos nuestros grupos de interés.
                    </p>
                    <p class="mt-4 text-gray-500">
                        Aunque provenimos de diferentes orígenes y culturas, <span
                            class="text-gray-900 font-medium">nuestros valores son lo que tenemos en común.</span>
                    </p>
                </div>
            </div>
            ...
            <div class="people-banner relative rounded-3xl overflow-hidden bg-secondary opacity-0 scale-95">
                ...
                <div class="relative z-10 p-10 md:p-16 text-center">
                    <h3 class="text-2xl md:text-3xl font-bold text-white mb-4">
                        Nuestra gente define quiénes somos
                    </h3>
                    <p class="text-lg text-gray-200 max-w-2xl mx-auto">
                        Ellos inspiran confianza, generan impacto e impulsan nuestro crecimiento como organización.
                    </p>
                </div>
            </div>
